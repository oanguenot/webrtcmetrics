...
export const defaultAudioMetricIn = {
  ...
  delta_ms_jitter_buffer_delay_in: 0,
  total_rtt_ms_in: 0,
...
export const defaultVideoMetricIn = {
  ...
  delta_ms_processing_delay_in: 0,
  delta_ms_assembly_delay_in: 0,
  delta_nack_sent_in: 0,
  delta_pli_sent_in: 0,
  delta_ms_jitter_buffer_delay_in: 0,
  delta_ms_jitter_buffer_emitted_in: 0,
  percent_packets_lost_in: 0,
  total_packets_in: 0,
  total_packets_lost_in: 0,
  total_KBytes_in: 0,
  ...
  total_time_jitter_buffer_delay_in: 0,
  total_time_jitter_emitted_in: 0,

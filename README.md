...
| **delta_avg_packet_delay_out** | Number  | Average duration spent by packets before being sent (in ms)                                               |
...
| **total_packets_delay_out**    | Number  | Total time spent for all packets before being sent (in ms)                                                |

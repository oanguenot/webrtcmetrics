...
**WebRTCMetrics** allows to capture any properties from the underlying WebRTC reports generated by the WebRTC stack.

For doing that, you need to know which report the property belongs to use the key `passthrough` to give it to WebRTCMetrics.
